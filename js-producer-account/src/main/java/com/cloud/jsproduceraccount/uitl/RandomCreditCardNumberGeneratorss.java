package com.cloud.jsproduceraccount.uitl;

import java.util.List;
import java.util.Stack;
import java.util.Vector;

public class RandomCreditCardNumberGeneratorss {


    public static final String[] VISA_PREFIX_LIST = new String[] { "4539",
            "4556", "4916", "4532", "4929", "40240071", "4485", "4716", "4" };

    public static final String[] MASTERCARD_PREFIX_LIST = new String[] { "62",
    ...
    public static final String[] ENROUTE_PREFIX_LIST = new String[] { "2018",
            "2149" };
