...
public class Detailenquiry implements Serializable {
    private static final long serialVersionUID = -54678583120925420L;
    //明细查询ID
    ...
    public String getDetailenquiryMoney() {
        return detailenquiryMoney;
    }

    public void setDetailenquiryMoney(String detailenquiryMoney) {
